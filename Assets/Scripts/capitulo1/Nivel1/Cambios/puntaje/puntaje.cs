...
public class InventarioJugador : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        GameLogger.LogToFile("InventarioJugador", $"Inventario inicializado. Recursos cargados en serialización: {recursosSerialized.Count}");
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (recurso != null)
        {
            ...
            // Registro en archivo .log específico
            GameLogger.LogToFile("InventarioJugador", $"[RECURSO RECOGIDO] +{recurso.cantidad} de '{recurso.nombreRecurso}' | Total acumulado: {recursos[recurso.nombreRecurso]}");
...
public class MenuVictoria : MonoBehaviour
{
    ...
    {
        GameLogger.LogToFile("InventarioJugador", "[MENÚ] Cargando escena de Menú Principal.");
    ...
    {
        GameLogger.LogToFile("InventarioJugador", "[MENÚ] Reiniciando nivel actual (Build Index: " + SceneManager.GetActiveScene().buildIndex + ")");
    ...
    public void SalirJuego()
    {
        ...
        GameLogger.LogToFile("InventarioJugador", "[MENÚ] Saliendo de la aplicación.");
        Application.Quit();
    }
}